SCHEMA = {
    ...
    "account_records": {
        ...
        "current_balance": "FLOAT, the LIVE computed current balance",
        "currency": "VARCHAR, the currency (e.g., USD, INR)",
        "notes": "VARCHAR, additional details",
    },
    "budget_records": {
        "record_id": "INTEGER PRIMARY KEY, foreign key to records.id",
        "category": "VARCHAR, the budget category",
    ...
    "income_records": {
        "record_id": "INTEGER PRIMARY KEY, foreign key to records.id",
        "source": "VARCHAR, who or what paid the user (e.g., salary, employer)",
