...
from records.transfer.models import UpdateTransfer, UpdateOperation
from records.transfer.resolver import resolve_record


def record_updater(state):
    extraction: UpdateTransfer = state.extraction
    db = SessionLocal()
    ...
    try:
        ...
        return {
            ...
            "response": f"Updated transfer from {record.source_account} to {record.destination_account}.",
        }
